...
namespace TPNOTE2
{
    public partial class Consultation : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            String request = "select E.Num_Etu, Nom_Etu, Prenom_Etu, Note FROM  Etudiant E, Note N WHERE E.Num_Etu = N.Num_Etu AND N.Num_Mod = @p1";
            ...
            dr.Close();
            SqlCommand command1 = new SqlCommand();
            String request1 = "select E.Num_Etu, Nom_Etu, Prenom_Etu, Note FROM  Etudiant E, Note N WHERE E.Num_Etu = N.Num_Etu AND N.Num_Mod = @p1";
